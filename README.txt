...
a persistence unit "eva62MashingashiPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "eva62Mashingashi/pom.xml":
...
artifact ("eva62Mashingashi.war") is already built. You can build
